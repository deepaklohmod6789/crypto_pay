...
import 'package:crypto_pay/pages/nftMarket/create_nft.dart';
import 'package:crypto_pay/pages/nftMarket/nft_tile.dart';
import 'package:crypto_pay/services/controllers/nft_market_controller.dart';
...
class _NFTMarketState extends State<NFTMarket> {
  ...
  void createNFT(BuildContext context){
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return const CreateNFT();
      },
    );
  }
